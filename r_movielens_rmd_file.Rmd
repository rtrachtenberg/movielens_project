...
When this code ran previously, I got an RMSE value of 0.953, so in case you didn't want to take 20-30 minutes to run the code above, I have added this rmse value to the table for simplicity and ease of evaluation. Set this code chunk to eval = FALSE in the rmd file if you would like to run the code above instead.
